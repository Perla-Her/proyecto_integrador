...
<center> <span style="color:indigo; font-size:16px;">Machine Learning e Inferencia Bayesiana  

UNIVERSIDAD DE GUADALAJARA</span> </center>

<center> <span style="color:DarkBlue; font-size:18px;"><b>Análisis de Precios de Canasta Básica entre tiendas - GEOPRECIO</b></span> </center>  
<center> <span style="color:Blue; font-size:14px;">Carretero Contretas Kitzia D., Cintora Ruvalcaba Samuel S., Hernández Juarez Perla, Molotla Jimenez Isaac E.</span> </center>

---

# Introducción

En este notebook aplicamos cinco modelos de *Machine Learning* sobre el dataset **GeoPrecios**, que contiene información de precios de productos de la canasta básica (aceite, leche, frijol y pasta) en cuatro tiendas: Bodega Aurrera, Walmart, Soriana y La Comer.
...
Al final se presenta una **comparativa general** de todos los modelos.
"""
